...
const App = () => {
  ...
  return (
    <div className="app text-center font-sans bg-gray-100 p-5 h-screen">
      ...
      <div className="quote-card bg-white border border-gray-300 rounded-lg p-5 m-5 max-w-xl mx-auto shadow-md">
        ...
        <div className="two-button flex justify-center gap-2">
          <button
            onClick={fetchQuote}
            className="py-2 px-3 text-lg border-none rounded  bg-gray-800 text-white cursor-pointer hover:bg-blue-700"
          >
            New Quote
          </button>
          <button
      ...
      <div className="saved-quotes max-w-xl mx-auto">
        <h2 className="text-xl mb-5 underline">Saved Quotes</h2>
